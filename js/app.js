...
let sliderHome = new Swiper('.slider__slide', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
...
let sliderFamous = new Swiper('.slider-famous__slide', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
	...
	*/
	...
	navigation: {
		nextEl: '.slider-famous__arrows-next',
		prevEl: '.slider-famous__arrows-prev',
	},
